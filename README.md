...
_G.TweenService = value

function TP(P1)
    if _G.TweenService then
...
section1:addButton("Fist", function(value)
    _G.TweenService = value 
    local CFrameEnd = CFrame.new(872.911, 14.6711, 1432.88)
    local Time = 15
...
section1:addButton("Jungle", function(value)
    _G.TweenService = value 
    local CFrameEnd = CFrame.new(-1337.4604492188, 11.852861404419, 497.52340698242)
    local Time = 15
    local tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Time), {CFrame = CFrameEnd}) tween:Play()
end)

section1:addButton("Pirate", function(value)
    _G.TweenService = value 
    local CFrameEnd = CFrame.new(-1157.6, 4.75206, 3805.46)
    local Time = 15
    local tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Time), {CFrame = CFrameEnd}) tween:Play()
end)
