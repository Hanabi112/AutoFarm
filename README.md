...
section1:addToggle("Lock Mon", _G.LockMon, function(L)
    _G.LockMon = L
    if _G.LockMon == true then
    while _G.LockMon do wait()
        cq()
...
section1:addButton("Floating Turtle",function()
    otarget(CFrame.new(-10919.2998, 331.788452, -8637.57227))
end)
section1:addButton("Mansion",function()
...
section1:addButton("Teler Park",function()
    otarget(CFrame.new(-9512.3623046875, 142.13258361816, 5548.845703125))
end)
